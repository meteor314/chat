	  				...
	  				if(strlen($pwd) >5 ) {
		  				...
		  				if(strlen($email) < 27 || strlen($userName)  < 15) {
		  					...
		  					if($answer == 0) { // if the mail doesn't exist in our database
			  					...
			  					$insert  = $db->prepare('INSERT INTO member (email, username, pwd) VALUES (?, ?, ?)');
			  					$insert->execute(array($email, $userName, $pwd,));
...
<body class="align">
  ...
  <div class="grid">
    ...
    <form action="#" method="POST" class="form login">
      ...
      <div class="form__field">
        <label for="login__username"><svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#user"></use></svg><span class="hidden">Username</span></label>
        <input id="login__username" type="text" name="email" class="form__input"type="email" placeholder="Email" required>
      </div>
      ...
      <div class="form__field">
        <label for="login__password"><svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#lock"></use></svg><span class="hidden">Password</span></label>
        <input id="login__password" type="password" name="pwd2" class="form__input" placeholder="Password Confirmation" required>
      </div>
    ...
    <p class="text--center">Déjà un compte ? <a href="login.php#">Se connecter</a> <svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="assets/images/icons.svg#arrow-right"></use></svg></p>
